    ...
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
            <form method="post" v-on:submit.prevent="onSubmitEditForm" v-if="categorys">
                <input type="hidden" v-model="categorys._id">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-xl-6 col-lg-6 col-sm-6">
                        <textarea class="form-control mb-4" rows="3" id="name" v-model="categorys.CategoryName"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-10 col-lg-9 col-sm-10">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" v-model="categorys.Status" :value="1"
                                    :checked="categorys.Status === 1" id="status"
                                    style="width: 16px;height: 16px;" />
                                <label class="form-check-label" for="flexCheckDefault"> Hoạt động
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" v-model="categorys.Status" :value="0"
                                    :checked="categorys.Status === 0" id="status"
                                    style="width: 16px;height: 16px;" />
...
export default {
    ...
    methods: {
        onSubmitEditForm() {
            ...
            if (this.categorys.CategoryName.length == 0) {
                this.nameError = {
            ...
            } else if (this.categorys.CategoryName.length < 5 || this.categorys.CategoryName.length > 50) {
                this.nameError = {
            ...
            if (this.codeSuccess.status == true && this.nameSuccess.status == true) {
                    CategoryServices.update(this.categorys)
                        .then((res) => {
                            console.log(res);
                        })
                        .catch((error) => {
